...
import edu.cs.hrbnu.temp.StudentCourseTemp;
...
//        System.out.println(studentId + courseId);
	...
	public String studentLogin(String studentId,String password,HttpServletRequest request,Model model){
	...
	public String studentOut(HttpServletRequest request){
